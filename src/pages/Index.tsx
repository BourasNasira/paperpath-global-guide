  ...
  const features = [
    {
      ...
      color: "bg-blue-500",
      number: "01",
      image: "/lovable-uploads/a6cc40ff-6784-4ea1-a95c-2e086cc7cb05.png", // image 1
    },
    {
      icon: Languages,
      ...
      color: "bg-green-500",
      number: "02",
      image: "/lovable-uploads/1728a585-77e5-48a3-9b68-c7d4213ec07d.png", // image 2
    },
    {
      icon: Headphones,
      ...
      color: "bg-purple-500",
      number: "03",
      image: "/lovable-uploads/88713b5b-ce37-425f-8244-3ec9fcc4d7a0.png", // image 3
    },
    {
      icon: MapPin,
      ...
      color: "bg-orange-500",
      number: "04",
      image: "/lovable-uploads/29334d10-7108-4382-82ae-66f7825a5a0c.png", // image 4
    },
  ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {features.map((feature, index) => (
                    <Card
                      ...
                      onClick={() => {
                        if (feature.title === t.documentGuide)
                          setCurrentView("documents");
                        if (feature.title === t.serviceLocator)
                          setCurrentView("services");
                        if (feature.title === t.audioSupport)
